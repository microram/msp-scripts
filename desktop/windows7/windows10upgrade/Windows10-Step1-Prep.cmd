...
:: Note some of these tools are our private copies, please adjust to your own download locations
...
:: Download files
aria2c https://www.grc.com/files/never10.exe %ariaopts%
aria2c https://www.7-zip.org/a/7z1900-x64.exe %ariaopts%
aria2c %s3w%/dl1/windows/mseinstall.exe %ariaopts%

:: Enable Windows 10 Upgrade
%temp%\never10.exe enable delete

:: Uninstall Microsoft Security Essentials
%temp%\mseinstall.exe /U /s

:: Install 7-Zip
%temp%\7z1900-x64.exe /S

:: Remove HP Drive Encryption
REM HP Page Lift
MsiExec.exe /X{59202086-BEA1-411A-8AA4-A5DCD28FF537} /qn /norestart
REM HP Drive Encryption
msiexec.exe /X{FE885DCE-4917-4E47-9881-883CBB3B8F50} /qn /norestart
msiexec.exe /X{2B54BCA5-E2DD-45F4-8B0D-A2473114EA57} /qn /norestart
msiexec.exe /X{27F1E086-5691-4EB8-8BA1-5CBA87D67EB5} /qn /norestart

REM Device Access Manager
MsiExec.exe /X{122104A2-D83A-47CC-A25D-DD1EC1AD2741} /qn /norestart
MsiExec.exe /X{DBE16A07-DDFF-4453-807A-212EF93916E0} /qn /norestart
REM File Sanitizer
MsiExec.exe /X{6349342F-9CEF-4A70-995A-2CF3704C2603} /qn /norestart
REM Theft Recovery
MsiExec.exe /X{B1E569B6-A5EB-4C97-9F93-9ED2AA99AF0E} /qn /norestart
REM Trust Circles
MsiExec.exe /X{A418FD4D-BE0F-4D1A-B139-A229ED133625} /qn /norestart
REM Protect Tools
MsiExec.exe /X{173D1DA9-D107-4C85-B1DA-773DB53EEA6F} /qn /norestart

START /WAIT /MIN WMIC product where "Name LIKE '%%Assistant%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Documentation%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Documentation%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Guide%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Energy Star%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%StatusAlerts%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Support%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Documentation%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Print SW%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Notifications%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Pixel Sharp%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP System Default Settings%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Support Assistant%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%Discover HP Touchpoint Manager%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP 3D DriveGuard%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Welcome%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Registration Service%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP Software Setup%%'" call uninstall /nointeractive
START /WAIT /MIN WMIC product where "Name LIKE '%%HP System Default Settings%%'" call uninstall /nointeractive
...
:: HP Privacy Manager for Protect Tools
